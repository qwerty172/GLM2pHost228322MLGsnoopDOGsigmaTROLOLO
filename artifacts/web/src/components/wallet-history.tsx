...
export const formatLzt = (lzt: number) =>
...
export function kindMeta(kind: string, amountLzt: number): KindMeta {
...
export function bucketMeta(bucket: string | null | undefined): {
  label: string;
  color: string;
} | null {
  switch (bucket) {
...
export function isDebtTx(kind: string, bucket: string | null | undefined): boolean {
  return (
