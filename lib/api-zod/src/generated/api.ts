...
export const AdminListGameSubmissionsResponseItem = zod
  .object({
    id: zod.string().uuid(),
    ...
    description: zod.string(),
    coverImageUrl: zod.string(),
    kind: zod.string().describe("native | browser"),
    ...
    submitterDisplayName: zod
      .string()
      .describe("Display name of the submitting host"),
  })
  .describe("Host request to add a game to the platform catalog.");
