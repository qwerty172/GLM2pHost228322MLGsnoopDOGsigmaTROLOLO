...
export const AdminListSubmissionsQueryParams = zod.object({
  status: zod
    ...
    .describe("Filter by moderation status (default pending)"),
});
...
export const AdminListSubmissionsResponseItem = zod.object({
  ...
  createdAt: zod.coerce.date(),
  submitterDisplayName: zod
    .string()
    .describe("Display name of the host who submitted the request"),
});
