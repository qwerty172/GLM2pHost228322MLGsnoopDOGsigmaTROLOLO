...
export type GameSubmissionAdminItemStatus =
  (typeof GameSubmissionAdminItemStatus)[keyof typeof GameSubmissionAdminItemStatus];

export const GameSubmissionAdminItemStatus = {
  pending: "pending",
  approved: "approved",
  rejected: "rejected",
} as const;

export type GameSubmissionAdminItemKind =
  (typeof GameSubmissionAdminItemKind)[keyof typeof GameSubmissionAdminItemKind];

export const GameSubmissionAdminItemKind = {
  native: "native",
  browser: "browser",
} as const;

export interface GameSubmissionAdminItem {
  id: string;
  hostId: string;
  status: GameSubmissionAdminItemStatus;
  title: string;
  slug: string;
  category: string;
  genres: string[];
  ...
  kind: GameSubmissionAdminItemKind;
