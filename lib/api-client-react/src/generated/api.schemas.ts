...
export type AdminGameSubmissionStatus =
  (typeof AdminGameSubmissionStatus)[keyof typeof AdminGameSubmissionStatus];

export const AdminGameSubmissionStatus = {
  pending: "pending",
  approved: "approved",
  rejected: "rejected",
} as const;

export type AdminGameSubmissionKind =
  (typeof AdminGameSubmissionKind)[keyof typeof AdminGameSubmissionKind];

export const AdminGameSubmissionKind = {
  native: "native",
  browser: "browser",
} as const;
...
export interface AdminGameSubmission {
  id: string;
  hostId: string;
  status: AdminGameSubmissionStatus;
  title: string;
  slug: string;
  category: string;
  genres: string[];
