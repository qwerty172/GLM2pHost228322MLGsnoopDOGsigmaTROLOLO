...
export type GameSubmissionListItemStatus =
  (typeof GameSubmissionListItemStatus)[keyof typeof GameSubmissionListItemStatus];

export const GameSubmissionListItemStatus = {
  pending: "pending",
  approved: "approved",
  rejected: "rejected",
} as const;
