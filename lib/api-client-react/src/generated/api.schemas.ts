...
export type GameSubmissionStatus =
  (typeof GameSubmissionStatus)[keyof typeof GameSubmissionStatus];

export const GameSubmissionStatus = {
  pending: "pending",
  approved: "approved",
  rejected: "rejected",
} as const;
...
export type GameSubmissionKind =
  (typeof GameSubmissionKind)[keyof typeof GameSubmissionKind];

export const GameSubmissionKind = {
  native: "native",
  browser: "browser",
} as const;
