...
/**
 * Register a getter that supplies the host token for admin routes.
 * When it returns a non-null string, an `X-Host-Token` header is attached.
 */
...
/**
 * Register a getter that supplies the deployment admin secret.
 * When it returns a non-null string, an `X-Admin-Secret` header is attached.
 */
