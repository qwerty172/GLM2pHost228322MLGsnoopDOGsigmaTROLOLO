...
## Marathon M-73 (2026-08-05 02:24 UTC) {#marathon-m-73}

| Проверка | Результат |
|---|---|
| quota-compatibility.test.mjs | 8 тестов — specsFromPcSpecs, computeQuotaHostTier, getQuotaCompatibility, validateQuotaFormFields |
| web test | PASS (33 tests) |
| web typecheck | skipped (libs not built in cloud env) |
