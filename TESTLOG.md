...
| `embed.tsx` | `createEmbedSession`, `getPublicIceConfig`, `getSessionByPlayerToken` (codegen) |
| `admin/games.tsx` | `useAdminListGames`, `useAdminListSubmissions`, admin mutations (codegen) |
