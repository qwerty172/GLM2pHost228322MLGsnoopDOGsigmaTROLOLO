...
## Marathon M-68 (2026-08-05 00:20 UTC) {#marathon-m-68}

| Проверка | Результат |
|---|---|
| input.test.mjs | 10 тестов — parseInputEvent (mousemove/mode/buttons/wheel/keys), parseGamepadState (clamp/reject), parseHostConfigPatch, LOCAL_INPUT_SECRET |
| host-agent test | PASS (196 tests) |
