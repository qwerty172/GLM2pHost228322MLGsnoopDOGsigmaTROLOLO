...
## Marathon M-68 (2026-08-05 00:22 UTC) {#marathon-m-68}

| Проверка | Результат |
|---|---|
| input.test.mjs | 11 тестов — constants, parseInputEvent (mode/buttons/wheel/keys), parseGamepadState (clamp/limits), parseHostConfigPatch |
