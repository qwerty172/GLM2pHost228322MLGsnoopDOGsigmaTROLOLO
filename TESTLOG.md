...
| Область | Изменение |
|---|---|
| OpenAPI | `adminListSubmissions`, `adminApproveSubmission`, `adminRejectSubmission` + схемы |
| api-client-react | `setHostTokenGetter`, `setAdminSecretGetter` в custom-fetch |
| web embed.tsx | `useCreateEmbedSession`, `getPublicIceConfig`, `useGetSessionByPlayerToken` |
| web admin/games.tsx | `useAdminListGames`, `useAdminListSubmissions`, approve/reject/patch/delete hooks |
