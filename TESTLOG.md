...
## Marathon M-63 (2026-08-04 23:10 UTC) {#marathon-m-63}

| Проверка | Результат |
|---|---|
| sentry.test.mjs | 4 теста — no-op без SENTRY_DSN, Sentry.init с DSN/NODE_ENV, fallback production, swallow missing @sentry/electron/main |
