...
| Backlog | [MARATHON.md](./MARATHON.md) — pending: C2-S06 /wallet, C2-D02 OpenAPI gaps, storage ACL, Windows E2E |
...
| api-client | `setHostTokenGetter`, `setAdminSecretGetter` — авто-заголовки для `/admin/*` |
| embed.tsx | `createEmbedSession`, `useGetPublicIceConfig`, `useGetSessionByPlayerToken` вместо raw fetch |
| admin/games.tsx | `useAdminListGames`, `useAdminListSubmissions`, approve/reject/patch/delete mutations |
