...
## Marathon M-61 (2026-08-04 22:22 UTC) {#marathon-m-61}

| Проверка | Результат |
|---|---|
| save-paths.test.mjs | 6 тестов — non-win32 guard, Steam userdata remote dir, Ludusavi cache templates, resolveSavePathCandidates без существующих путей |
