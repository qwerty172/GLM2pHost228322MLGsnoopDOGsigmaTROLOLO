...
## Marathon M-37 (2026-08-04 09:10 UTC) {#marathon-m-37}

| Проверка | Результат |
|---|---|
| library.tsx | apiFetch + 4 вызова → `useRawgSearch`, `steamLookup`, `useSubmitGame`, `usePatchSubmissionPendingConfig` |
| typecheck | PASS (`@workspace/web`) |
| marathon-scan | library.tsx больше не в raw hits F |

**Следующий pick:** M-38 `web: raw fetch → codegen (1 call)` — следующий файл из F.
