...
## Marathon M-57 (2026-08-04 20:16 UTC) {#marathon-m-57}

| Проверка | Результат |
|---|---|
| input-injection.test.mjs | 7 тестов — noop non-win32, mocked SendInput absolute/relative mouse, buttons/wheel/keys, Raw Input, koffi failure |
