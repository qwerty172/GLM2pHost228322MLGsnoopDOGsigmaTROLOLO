...
## Marathon M-61 (2026-08-04 22:32 UTC) {#marathon-m-61}

| Проверка | Результат |
|---|---|
| save-paths.test.mjs | 8 тестов — non-win32 guard, Steam userdata, Ludusavi templates, resolveSavePathCandidates, platform filter |
| host-agent test | PASS (140 tests) |
| typecheck | PASS |
