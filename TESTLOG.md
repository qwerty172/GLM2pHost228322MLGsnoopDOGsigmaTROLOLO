...
## Marathon M-84 (2026-08-05 06:24 UTC) {#marathon-m-84}

| Проверка | Результат |
|---|---|
| layout-nav.ts | экспорт HOST_LAYOUT_NAV_ITEMS, resolveHostSiteNavActivePath, isHostNavItemActive |
| layout.tsx | реэкспорт хелперов; HostLayout использует layout-nav + иконки |
| layout.test.mjs | 4 теста — nav items, site-nav active path, nav item active state |
