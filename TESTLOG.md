...
## Marathon M-73 (2026-08-05 02:50 UTC) {#marathon-m-73}

| Проверка | Результат |
|---|---|
| quota-compatibility.test.mjs | 8 тестов — specsFromPcSpecs, computeQuotaHostTier (stream overhead), getQuotaCompatibility (min/rec tier), validateQuotaFormFields |
