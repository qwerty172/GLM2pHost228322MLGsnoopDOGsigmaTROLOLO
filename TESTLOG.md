...
| **marathon** | **2026-07-31** | C1-S06 storage ACL: legacy uploads public, saves private |
...
| Storage ACL | `uploads/*` legacy public read; saves/clips private ACL; 401 без ACL на остальное |
