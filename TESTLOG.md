...
## Marathon M-37 (2026-08-04 09:14 UTC) {#marathon-m-37}

| Проверка | Результат |
|---|---|
| library.tsx | raw fetch → `rawgSearch`, `steamLookup`, `submitGame`, `patchSubmissionPendingConfig`; удалён `apiFetch` |
| typecheck | PASS (`pnpm --filter @workspace/web run typecheck`) |
