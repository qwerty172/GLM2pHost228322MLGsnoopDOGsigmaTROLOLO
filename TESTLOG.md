...
## Marathon M-75 (2026-08-05 03:10 UTC) {#marathon-m-75}

| Проверка | Результат |
|---|---|
| utils.test.mjs | 5 тестов — cn() merge, falsy, conditional, tailwind-merge, arrays |
| web test | PASS (43 tests) |
| web typecheck | PASS |

**Следующий pick:** idle (кат. L закрыта).
