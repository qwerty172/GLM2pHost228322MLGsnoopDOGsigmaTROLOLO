...
## Marathon M-49 (2026-08-04 14:44 UTC) {#marathon-m-49}

| Проверка | Результат |
|---|---|
| play.tsx | 3× `eslint-disable exhaustive-deps` → корректные deps в useEffect (registerGuest, claim, startConnection) |
| marathon-scan | play.tsx больше не в raw hits I |
| typecheck | play.tsx без lint-ошибок; monorepo typecheck — pre-existing env issues |
