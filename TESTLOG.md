...
## Marathon M-73 (2026-08-05 02:42 UTC) {#marathon-m-73}

| Проверка | Результат |
|---|---|
| quota-compatibility.test.mjs | 6 тестов — specsFromPcSpecs, computeQuotaHostTier, getQuotaCompatibility, validateQuotaFormFields |
| web test | PASS (31 tests) |
| web typecheck | PASS |
