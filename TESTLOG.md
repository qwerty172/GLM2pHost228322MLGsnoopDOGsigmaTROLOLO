...
## Marathon M-40 (2026-08-04 12:20 UTC) {#marathon-m-40}

| Проверка | Результат |
|---|---|
| game-detail.tsx | 6 raw fetch → `useSteamLookup`, `useListPublicGameHosts`, `useBrowserPingMs`, `createPreviewSession`, `getPublicIceConfig`, `publicPing` |
