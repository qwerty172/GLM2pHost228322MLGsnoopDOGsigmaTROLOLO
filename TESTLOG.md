...
## Marathon M-50 (2026-08-04 15:22 UTC) {#marathon-m-50}

| Проверка | Результат |
|---|---|
| game-detail.tsx | `eslint-disable react-hooks/exhaustive-deps` убран — deps `[hostId, cleanup, startCountdown]` в PreviewModal |
