...
## Marathon M-88 (2026-08-05 07:24 UTC) {#marathon-m-88}

| Проверка | Результат |
|---|---|
| wallet-history.tsx | экспорт formatLzt, formatTs, kindMeta, bucketMeta, isDebtTx, WALLET_HISTORY_FILTERS, WALLET_HISTORY_PAGE_SIZE |
| wallet-history.test.mjs | 8 тестов — LZT format, timestamps, kind/bucket labels, debt filter, page size |
| web test | PASS (123 tests) |
| typecheck | PASS |
