...
## Marathon M-10 (2026-08-03 13:02 UTC) {#marathon-m-10}

| Проверка | Результат |
|---|---|
| OpenAPI | `POST /games/submit`, `PATCH /games/submissions/{id}/pending-config`, `GET /games/submissions/my` + schemas SubmitGameBody, GameSubmission, PendingHostConfigBody |
| codegen | orval → api-client-react + api-zod (`submitGame`, `patchGameSubmissionPendingConfig`, `listMyGameSubmissions`) |
| typecheck | PASS |
