...
## Marathon M-51 (2026-08-04 16:14 UTC) {#marathon-m-51}

| Проверка | Результат |
|---|---|
| webgl-video-shader.tsx | `eslint-disable react-hooks/exhaustive-deps` убран — `onCompileErrorRef` + deps `[active, fragCode, videoRef]` |
