...
## Marathon M-56 (2026-08-04 18:31 UTC) {#marathon-m-56}

| Проверка | Результат |
|---|---|
| gamepad-injection.test.mjs | 6 тестов — noop non-Windows, focus guard, mocked ViGEm connect + XUSB report |
| host-agent test | PASS (108 tests) |
| typecheck | PASS |
