...
## Marathon M-58 (2026-08-04 20:28 UTC) {#marathon-m-58}

| Проверка | Результат |
|---|---|
| limited-user-launch.test.mjs | 6 тестов — non-win32 guard, creds validation, mocked win32 spawn/env, koffi failure |
