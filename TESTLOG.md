...
## Marathon M-08 (2026-08-03 12:52 UTC) {#marathon-m-08}

| Проверка | Результат |
|---|---|
| OpenAPI | `POST /sessions/{id}/metrics` + SessionMetricSample/PostSessionMetricsBody |
| codegen | orval → api-client-react + api-zod (`postSessionMetrics`) |
| typecheck | PASS |
| marathon-scan | sessions.ts metrics route закрыт (5/5 pending) |
