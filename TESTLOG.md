...
## Marathon M-40 (2026-08-04 11:48 UTC) {#marathon-m-40}

| Проверка | Результат |
|---|---|
| game-detail.tsx | 6 raw fetch → `useSteamLookup`, `useListPublicGameHosts`, `createPreviewSession`, `getPublicIceConfig`, `publicPing`, shared `useBrowserPingMs` |
