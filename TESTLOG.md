...
## Marathon M-70 (2026-08-05 01:02 UTC) {#marathon-m-70}

| Проверка | Результат |
|---|---|
| api-errors.test.mjs | 5 тестов — extractApiErrorPayload, formatApiError (коды/EN/паттерны), formatApiErrorPanel |
