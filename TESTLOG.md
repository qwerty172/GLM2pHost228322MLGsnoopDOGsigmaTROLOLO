...
## Marathon M-80 (2026-08-05 04:48 UTC) {#marathon-m-80}

| Проверка | Результат |
|---|---|
| use-player-wallet.tsx | экспорт PLAYER_WALLET_STORAGE_KEY, readGuestFlagFromStorage, persistGuest/UpgradedWalletToken, registerGuestWalletAsync, upgradeGuestWalletAsync |
| use-player-wallet.test.mjs | 10 тестов — storage keys, guest flag, persist, register/upgrade success и failure |
| web test | PASS (73 tests) |
| typecheck | PASS |

**Следующий pick:** idle (Wave M hooks покрыты).
