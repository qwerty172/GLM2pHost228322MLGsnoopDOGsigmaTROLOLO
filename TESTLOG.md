...
## Marathon M-90 (2026-08-05 09:20 UTC) {#marathon-m-90}

| Проверка | Результат |
|---|---|
| marathon-scan.mjs | добавлена категория O (web pages с inline helpers) — 19 задач |
...
| admin-games.test.mjs | 6 тестов — headers, API errors, status labels, cover URL |
