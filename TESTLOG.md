...
## Marathon M-58 (2026-08-04 20:36 UTC) {#marathon-m-58}

| Проверка | Результат |
|---|---|
| limited-user-launch.test.mjs | 7 тестов — Windows-only guard, creds validation, mocked cmd.exe spawn, domain env, koffi failure |
| host-agent test | PASS (122 tests) |
| typecheck | PASS |
