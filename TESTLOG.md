...
## Marathon M-58 (2026-08-04 20:48 UTC) {#marathon-m-58}

| Проверка | Результат |
|---|---|
| limited-user-launch.test.mjs | 6 тестов — Windows-only guard, creds validation, mocked cmd spawn, domain default, koffi/spawn failure |
