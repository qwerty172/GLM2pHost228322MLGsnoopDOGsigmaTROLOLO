...
## Marathon M-70 (2026-08-05 02:00 UTC) {#marathon-m-70}

| Проверка | Результат |
|---|---|
| api-errors.test.mjs | 7 тестов — extractApiErrorPayload, formatApiError (коды/EN/паттерны/RU), formatApiErrorPanel |
