...
## Marathon M-57 (2026-08-04 20:21 UTC) {#marathon-m-57}

| Проверка | Результат |
|---|---|
| input-injection.test.mjs | 7 тестов — defensive copy, noop non-win32, mocked SendInput mouse/keyboard/wheel, koffi init failure |
