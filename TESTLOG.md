...
## Marathon M-84 (2026-08-05 06:34 UTC) {#marathon-m-84}

| Проверка | Результат |
|---|---|
| layout.tsx | экспорт HOST_NAV_ITEMS, resolveHostSiteNavActivePath, isHostNavItemActive |
| layout.test.mjs | 4 теста — nav items, activePath mapping, exact match active state |
