...
## Marathon M-35 (2026-08-04 08:00 UTC) {#marathon-m-35}

| Проверка | Результат |
|---|---|
| profile.tsx | 2 raw fetch → `useListMyVds`, `usePatchPlayerCreditSettings` |
| OpenAPI | PATCH `/players/me/credit-settings` + backend route |
| typecheck | PASS (workspace) |
