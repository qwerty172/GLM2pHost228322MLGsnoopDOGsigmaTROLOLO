...
## Marathon M-70 (2026-08-05 01:20 UTC) {#marathon-m-70}

| Проверка | Результат |
|---|---|
| api-errors.test.mjs | 11 тестов — extractApiErrorPayload, formatApiError (коды/EN/RU/паттерны), formatApiErrorPanel |
