...
## Marathon M-50 (2026-08-04 15:26 UTC) {#marathon-m-50}

| Проверка | Результат |
|---|---|
| game-detail.tsx | `eslint-disable react-hooks/exhaustive-deps` убран — deps `[host.hostId, cleanup, startCountdown]` |
