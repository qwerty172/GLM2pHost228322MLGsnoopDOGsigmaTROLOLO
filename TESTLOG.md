...
## Marathon M-67 (2026-08-05 00:00 UTC) {#marathon-m-67}

| Проверка | Результат |
|---|---|
| wake-scheduler.test.mjs | 7 тестов — non-win32 no-op, schtasks cleanup при manual/empty slots, WakeToRun registration, query/delete/ps error swallow |
