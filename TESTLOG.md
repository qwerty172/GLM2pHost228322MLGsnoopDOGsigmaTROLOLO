...
## Marathon M-70 (2026-08-05 01:32 UTC) {#marathon-m-70}

| Проверка | Результат |
|---|---|
| api-errors.test.mjs | 7 тестов — extractApiErrorPayload, formatApiError (коды/EN/RU/patterns), formatApiErrorPanel |
| web test | PASS (15 tests) |
| web typecheck | PASS |
