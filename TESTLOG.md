...
## Marathon M-40 (2026-08-04 12:02 UTC) {#marathon-m-40}

| Проверка | Результат |
|---|---|
| game-detail.tsx | 6 raw fetch → `useSteamLookup`, `useListPublicGameHosts`, `publicPing`, `createPreviewSession`, `getPublicIceConfig` |
