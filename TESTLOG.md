...
## Marathon M-73 (2026-08-05 02:32 UTC) {#marathon-m-73}

| Проверка | Результат |
|---|---|
| quota-compatibility.test.mjs | 4 теста — specsFromPcSpecs, computeQuotaHostTier (STREAM_OVERHEAD), getQuotaCompatibility, validateQuotaFormFields |
| web test | PASS (29 tests) |
| web typecheck | PASS |
