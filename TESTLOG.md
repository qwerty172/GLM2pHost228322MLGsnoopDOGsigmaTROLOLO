...
## Marathon M-79 (2026-08-05 04:18 UTC) {#marathon-m-79}

| Проверка | Результат |
|---|---|
| use-mobile.tsx | экспорт MOBILE_BREAKPOINT, MOBILE_MEDIA_QUERY, isMobileViewportWidth |
| use-mobile.test.mjs | 4 теста — breakpoint, media query, mobile/desktop widths |
