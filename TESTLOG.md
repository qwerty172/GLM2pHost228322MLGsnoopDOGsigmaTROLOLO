...
| **marathon** | **2026-07-29** | Wave UX: UX-02 dashboard troubleshoot — см. MARATHON.md |
...
## Marathon Wave UX (2026-07-29) {#marathon-ux-02}

| Задача | Результат |
|---|---|
| UX-02 dashboard agent | Расширенный troubleshoot на `/host`: таблица симптомов (HOSTING §9), пути к логам, карточка stale-heartbeat, авто-раскрытие при ошибках telemetry |
| Верификация | `pnpm typecheck`, api-server test, host-agent test |
