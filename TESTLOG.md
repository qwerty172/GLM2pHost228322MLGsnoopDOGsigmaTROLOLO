...
## Marathon M-67 (2026-08-04 23:52 UTC) {#marathon-m-67}

| Проверка | Результат |
|---|---|
| wake-scheduler.test.mjs | 6 тестов — dayToWinDay, utcSlotToLocal, parseWakeTaskNames, buildWakeTaskScript (WakeToRun/escape), non-win32 guard |
