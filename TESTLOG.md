...
## Marathon M-60 (2026-08-04 20:59 UTC) {#marathon-m-60}

| Проверка | Результат |
|---|---|
| rtmp-relay.test.mjs | 14 тестов — non-win32 guard, mocked ffmpeg spawn/args, RTMP URL placeholder, idempotent start, stop/sync title, fetchStreamRelayConfig |
