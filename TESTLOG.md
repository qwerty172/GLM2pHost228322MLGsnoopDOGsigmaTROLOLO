...
## Marathon M-40 (2026-08-04 12:00 UTC) {#marathon-m-40}

| Проверка | Результат |
|---|---|
| game-detail.tsx | 6 raw fetch → codegen: `useSteamLookup`, `useListPublicGameHosts`, `useBrowserPingMs`, `publicPing`, `createPreviewSession`, `getPublicIceConfig` |
