...
## Marathon M-65 (2026-08-04 23:34 UTC) {#marathon-m-65}

| Проверка | Результат |
|---|---|
| steam-scanner.test.mjs | 11 тестов — non-win32 guard, registry root, Steam not found, ACF scan, UserConfig exe, dedup, resolve path, scan state roundtrip |
