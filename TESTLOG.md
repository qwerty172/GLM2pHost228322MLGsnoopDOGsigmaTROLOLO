...
## Marathon M-70 (2026-08-05 02:02 UTC) {#marathon-m-70}

| Проверка | Результат |
|---|---|
| api-errors.test.mjs | 6 тестов — extractApiErrorPayload, formatApiError (коды/EN/паттерны/fallback), formatApiErrorPanel |
