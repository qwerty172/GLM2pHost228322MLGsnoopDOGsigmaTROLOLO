...
| Область | Изменение |
|---|---|
| OpenAPI | `GET/POST /admin/games/submissions` (+ approve/reject); параметры `AdminHostToken` + `AdminSecret` |
| embed.tsx | `useCreateEmbedSession`, `useGetPublicIceConfig`, `useGetSessionByPlayerToken` — raw fetch убран |
