...
## Marathon M-73 (2026-08-05 02:54 UTC) {#marathon-m-73}

| Проверка | Результат |
|---|---|
| quota-compatibility.test.mjs | 9 тестов — specsFromPcSpecs, computeQuotaHostTier (overhead), getQuotaCompatibility (tier/reason), validateQuotaFormFields |
