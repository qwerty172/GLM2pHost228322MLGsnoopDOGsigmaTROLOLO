...
## Marathon M-61 (2026-08-04 21:40 UTC) {#marathon-m-61}

| Проверка | Результат |
|---|---|
| save-paths.test.mjs | 5 тестов — non-win32 guard, Steam userdata paths, Ludusavi templates, resolveSavePathCandidates, steamAppId override |
