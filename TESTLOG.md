...
## Marathon M-60 (2026-08-04 21:05 UTC) {#marathon-m-60}

| Проверка | Результат |
|---|---|
| rtmp-relay.test.mjs | 13 тестов — mocked spawn/ffmpeg, gdigrab args, {stream_key}, sync title, fetchStreamRelayConfig |
