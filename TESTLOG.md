...
## Marathon M-70 (2026-08-05 01:48 UTC) {#marathon-m-70}

| Проверка | Результат |
|---|---|
| api-errors.test.mjs | 5 тестов — extractApiErrorPayload, formatApiError (коды/EN/RU/patterns), formatApiErrorPanel |
| web test | PASS (13 tests) |
| web typecheck | PASS |
