...
## Marathon M-87 (2026-08-05 07:06 UTC) {#marathon-m-87}

| Проверка | Результат |
|---|---|
| vt-scanner.tsx | экспорт VT_STATUS_LABELS, isValidVtInput, canTriggerVtScan, isVtUrlInput, buildVtNetworkErrorResult |
| vt-scanner.test.mjs | 7 тестов — status labels, SHA-256/URL validation, scan guard, URL hint, network error |
