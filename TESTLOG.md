...
## Marathon M-63 (2026-08-04 23:06 UTC) {#marathon-m-63}

| Проверка | Результат |
|---|---|
| sentry.test.mjs | 4 тестов — no-op без DSN, Sentry.init с NODE_ENV, default production, swallow missing optional dep |
