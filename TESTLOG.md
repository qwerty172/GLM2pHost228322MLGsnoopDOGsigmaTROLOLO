...
## Marathon M-61 (2026-08-04 22:42 UTC) {#marathon-m-61}

| Проверка | Результат |
|---|---|
| save-paths.test.mjs | 7 тестов — non-win32 guard, Steam userdata discovery, Ludusavi cache/templates, resolveSavePathCandidates, steamAppId override, OS filter |
| host-agent test | PASS (139 tests) |
| typecheck | PASS |
