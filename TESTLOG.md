...
## Marathon M-58 (2026-08-04 20:31 UTC) {#marathon-m-58}

| Проверка | Результат |
|---|---|
| limited-user-launch.test.mjs | 5 тестов — Windows-only guard, creds validation, mocked spawn pid/domain, koffi failure |
