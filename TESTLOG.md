...
## Marathon M-70 (2026-08-05 01:34 UTC) {#marathon-m-70}

| Проверка | Результат |
|---|---|
| api-errors.test.mjs | 8 тестов — extractApiErrorPayload, formatApiError (коды/EN/RU/patterns), formatApiErrorPanel |
| web test | PASS (16 tests) |
| web typecheck | PASS |
