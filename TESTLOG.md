...
## Marathon M-61 (2026-08-04 21:46 UTC) {#marathon-m-61}

| Проверка | Результат |
|---|---|
| save-paths.test.mjs | 5 тестов — non-win32 guard, Steam userdata dirs, Ludusavi cache templates, resolveSavePathCandidates, steamAppId override |
| host-agent test | PASS (137 tests) |
| typecheck | PASS |
