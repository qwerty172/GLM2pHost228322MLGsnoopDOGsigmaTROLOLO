...
## Marathon M-70 (2026-08-05 01:50 UTC) {#marathon-m-70}

| Проверка | Результат |
|---|---|
| api-errors.test.mjs | 8 тестов — extractApiErrorPayload, formatApiError (коды/EN/паттерны/RU), formatApiErrorPanel |
