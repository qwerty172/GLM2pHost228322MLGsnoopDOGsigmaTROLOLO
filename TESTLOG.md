...
## Marathon M-61 (2026-08-04 21:53 UTC) {#marathon-m-61}

| Проверка | Результат |
|---|---|
| save-paths.test.mjs | 6 тестов — non-win32 guard, Steam userdata discovery, resolveSavePathCandidates fallback, Ludusavi cache + stale fallback |
