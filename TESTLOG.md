...
## Marathon M-67 (2026-08-05 00:08 UTC) {#marathon-m-67}

| Проверка | Результат |
|---|---|
| wake-scheduler.test.mjs | 8 тестов — non-win32 no-op, inactive schedule cleanup, PowerShell WakeToRun per slot, CloudGamingWake_ prefix filter, schtasks/powershell error swallow |
