...
## Marathon M-70 (2026-08-05 01:28 UTC) {#marathon-m-70}

| Проверка | Результат |
|---|---|
| api-errors.test.mjs | 4 теста — extractApiErrorPayload, formatApiError (коды/EN/RU/pattern), formatApiErrorPanel |
