...
## Marathon M-63 (2026-08-04 22:54 UTC) {#marathon-m-63}

| Проверка | Результат |
|---|---|
| sentry.test.mjs | 4 теста — no-op без SENTRY_DSN, init с NODE_ENV, default production, swallow missing @sentry/electron/main |
