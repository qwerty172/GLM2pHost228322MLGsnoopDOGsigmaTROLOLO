...
//   L. web src/lib/*.ts without unit test (by file)
//
...
const CAT_ORDER = { B: 0, C: 1, A: 2, G: 3, F: 4, E: 5, H: 6, L: 7, J: 8, K: 9, D: 10, I: 11 };
...
if (NEXT || PICK) {
  ...
  console.log(
    `\nКатегории: A=RU-строки, B=TODO/FIXME, C=OpenAPI gap, D=debug, E=renderer-тесты, F=raw fetch, G=HOSTING backlog, H=api-lib тесты, L=web-lib тесты, J=main-тесты, K=shared-тесты, I=eslint suppressions.`,
  );
