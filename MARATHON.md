...
> **Последнее обновление:** 2026-08-05 (M-76 done; scanner regex fix + connection-labels unit-тест)

## Last run (automation)

| Поле | Значение |
|------|----------|
| Дата | 2026-08-05 03:38 UTC |
| Task ID | M-76 |
| Результат | scanner regex fix (typed const exports) + unit-тест connection-labels.ts — ICE labels, tones, RU copy |
| Commit | 7ac272d |
...
**Wave Maintenance:** idle — web lib unit-тесты (M-69…M-76) done.
