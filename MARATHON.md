...
| M-147 | R | UX U-31 (P0): Кнопка «Скачать агент» отдаёт готовый `.exe`, а не ZIP с Nod | `routes/downloads.ts` | r:U-31 | pending | agent |
| M-148 | R | UX U-32 (P0): Тест реально проверяет, что hostToken лежит внутри ZIP, а не | `routes/downloads.test.ts` | r:U-32 | pending | agent |
