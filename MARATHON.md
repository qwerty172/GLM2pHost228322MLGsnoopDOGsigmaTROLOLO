...
| Поле | Значение |
|------|----------|
| Дата | 2026-08-04 12:40 UTC |
| Task ID | M-40 |
| Результат | game-detail.tsx — 6 raw fetch → codegen hooks (`useListPublicGameHosts`, `useSteamLookup`, `createPreviewSession`, `getPublicIceConfig`, `publicPing`, `useBrowserPingMs`) |
| Commit | 22b7282 |
