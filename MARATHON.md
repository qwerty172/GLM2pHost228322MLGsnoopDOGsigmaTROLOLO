...
| C1-S06 | Storage ACL legacy public read | P1 | done | agent | legacy deny; saves private; covers public |
...
| C1-F05 | Central auth middleware | P2 | done | agent | lib/authMiddleware.ts |
