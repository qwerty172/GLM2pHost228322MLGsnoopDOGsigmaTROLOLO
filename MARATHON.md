...
> **Последнее обновление:** 2026-08-05 (M-91 done; embed helpers + unit-тест)

## Last run (automation)

| Поле | Значение |
|------|----------|
| Дата | 2026-08-05 09:41 UTC|
| Task ID | M-91|
| Результат | embed-helpers.ts + embed.test.mjs (6 тестов): query params, missing params, ended UI, WS URL|
