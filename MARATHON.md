...
| Поле | Значение |
|------|----------|
| Дата | 2026-08-05 06:46 UTC |
| Task ID | M-85 |
| Результат | QuotaAiChat: экспорт QUOTA_AI_CHAT_STARTERS, shouldSendQuotaMessageOnEnter, canSendQuotaMessage, hasQuotaFormPatch + quota-ai-chat.test.mjs (5 тестов) |
| Commit | 7ebaf58 |
