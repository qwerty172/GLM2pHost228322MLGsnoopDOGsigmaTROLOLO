...
| Task ID | M-80 |
| Результат | web hooks: unit-тест use-player-wallet.tsx (guest register/upgrade, localStorage keys) |
| Commit | 0a0a76a |
...
**Wave Maintenance:** M-80 done — Wave .tsx hooks закрыта; сканер idle.
