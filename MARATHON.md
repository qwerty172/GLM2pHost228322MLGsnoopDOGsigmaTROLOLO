...
| Поле | Значение |
|------|----------|
| Дата | 2026-08-04 12:08 UTC |
| Task ID | M-40 |
| Результат | game-detail.tsx — 6 raw fetch → codegen (`useSteamLookup`, `useListPublicGameHosts`, `createPreviewSession`, `getPublicIceConfig`, `publicPing`, shared `useBrowserPingMs`) |
| Commit | 33ccd21 |
