...
| W9-4 | Авто-воркер крипто-выплат (PLAN 3.1) | done |

## W10 — Библиотека хоста (2026-07-28)

| ID | Задача | Статус |
|---|---|---|
| W10-1 | Активные сессии по каждой игре в библиотеке (PLAN 2.4) | done |

## W11 — Хост & экономика (2026-07-28)

| ID | Задача | Статус |
|---|---|---|
| W11-1 | Свои цены по тирам игроков bronze/silver/gold (PLAN 2.5) | pending |
| W11-2 | Уведомления о модерации заявок на игры (PLAN 2.6) | pending |
| W11-3 | Авто-подхват квоты агентом перед сессией (PLAN 2.8) | pending |
| W11-4 | Фильтр подходящих квот по железу ПК (PLAN 2.9) | pending |
| W11-5 | VDS-игры отдельной секцией в каталоге (PLAN 2.10) | pending |
