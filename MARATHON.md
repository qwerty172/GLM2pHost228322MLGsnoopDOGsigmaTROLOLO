...
> **Последнее обновление:** 2026-08-05 (M-104 done; quota-detail helpers + unit-тест)

## Last run (automation)

| Поле | Значение |
|------|----------|
| Дата | 2026-08-05 10:47 UTC|
| Task ID | M-104|
| Результат | quota-detail-helpers.ts + quota-detail.test.mjs (9 тестов): fmtLzt, kind labels, royalty rate/source, description, movement kind, closeable status, close button|
...
**Wave Maintenance:** M-104 done; scanner cat O — 2 pending (web pages helpers).
