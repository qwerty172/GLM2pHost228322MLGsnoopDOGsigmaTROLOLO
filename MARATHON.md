...
| Поле | Значение |
|------|----------|
| Дата | 2026-08-04 12:30 UTC |
| Task ID | M-40 |
| Результат | game-detail.tsx — 6 raw fetch → codegen (steamLookup, listPublicGameHosts, publicPing, createPreviewSession, getPublicIceConfig) |
| Commit | 40af36b |
