...
> **Последнее обновление:** 2026-08-04 (M-42 done; vt-scanner.tsx codegen)
...
**Wave Maintenance:** **5 M-NN pending** (M-49…M-53) — api-lib unit-тесты (M-48) done.
...
| M-43 | F | web: raw fetch → codegen (1 call) | `artifacts/web/src/components/quota-ai-chat.tsx` | f:artifacts/web/src/components/quota-ai-chat.tsx | done | agent |
| M-48 | H | api-server lib: unit-тесты (45 модулей) | `artifacts/api-server/src/lib/*.ts` | h:api-lib | done | agent |
