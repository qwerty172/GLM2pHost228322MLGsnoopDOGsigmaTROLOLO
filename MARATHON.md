...
| Поле | Значение |
|------|----------|
| Дата | 2026-08-04 08:38 UTC |
| Task ID | M-39 |
| Результат | games.tsx — 1 raw fetch → `useListGames({ vdsOnly, liveOnly })` |
| Commit | f107deb |
...
**Wave Maintenance:** **12 M-NN pending** (M-37…M-38, M-40…M-53) — сканер расширен категориями F–I.
