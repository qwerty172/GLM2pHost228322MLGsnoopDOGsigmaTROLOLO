...
| Поле | Значение |
|------|----------|
| Дата | 2026-08-05 07:06 UTC |
| Task ID | M-87 |
| Результат | VtScanner: экспорт VT_STATUS_LABELS, isValidVtInput, canTriggerVtScan, isVtUrlInput, buildVtNetworkErrorResult + vt-scanner.test.mjs (7 тестов) |
| Commit | pending |
