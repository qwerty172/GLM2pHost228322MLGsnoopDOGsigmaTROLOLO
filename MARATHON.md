...
| Поле | Значение |
|------|----------|
| Дата | 2026-08-05 07:24 UTC |
| Task ID | M-88 |
| Результат | WalletHistory: экспорт formatLzt, formatTs, kindMeta, bucketMeta, isDebtTx, WALLET_HISTORY_FILTERS, WALLET_HISTORY_PAGE_SIZE + wallet-history.test.mjs (8 тестов) |
| Commit | 3f3ba93 |
