...
> **Последнее обновление:** 2026-08-05 (M-76 done; web hooks unit-тест + scanner M)
...
**Wave Maintenance:** M-77 pending (use-platform-events hook). Scanner расширен: cat M (web hooks), L regex `export const:`.
...
| M-76 | M | web hooks: unit-тест (use-browser-ping.ts) | `artifacts/web/src/hooks/use-browser-ping.ts` | m:artifacts/web/src/hooks/use-browser-ping.ts | done | agent |
| M-77 | M | web hooks: unit-тест (use-platform-events.ts) | `artifacts/web/src/hooks/use-platform-events.ts` | m:artifacts/web/src/hooks/use-platform-events.ts | pending | agent |
