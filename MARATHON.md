...
> **Последнее обновление:** 2026-08-05 (M-81 done; KeyboardOverlay unit-тест + scanner cat O)
...
**Wave Maintenance:** M-81 done; M-82…M-89 pending (web components unit-тесты).
...
| M-81 | O | web components: unit-тест (KeyboardOverlay.tsx) | `artifacts/web/src/components/KeyboardOverlay.tsx` | o:artifacts/web/src/components/KeyboardOverlay.tsx | done | agent |
| M-82 | O | web components: unit-тест (TouchOverlay.tsx) | `artifacts/web/src/components/TouchOverlay.tsx` | o:artifacts/web/src/components/TouchOverlay.tsx | pending | agent |
| M-83 | O | web components: unit-тест (host-auth-guard.tsx) | `artifacts/web/src/components/host-auth-guard.tsx` | o:artifacts/web/src/components/host-auth-guard.tsx | pending | agent |
| M-84 | O | web components: unit-тест (layout.tsx) | `artifacts/web/src/components/layout.tsx` | o:artifacts/web/src/components/layout.tsx | pending | agent |
| M-85 | O | web components: unit-тест (quota-ai-chat.tsx) | `artifacts/web/src/components/quota-ai-chat.tsx` | o:artifacts/web/src/components/quota-ai-chat.tsx | pending | agent |
| M-86 | O | web components: unit-тест (site-nav.tsx) | `artifacts/web/src/components/site-nav.tsx` | o:artifacts/web/src/components/site-nav.tsx | pending | agent |
| M-87 | O | web components: unit-тест (vt-scanner.tsx) | `artifacts/web/src/components/vt-scanner.tsx` | o:artifacts/web/src/components/vt-scanner.tsx | pending | agent |
| M-88 | O | web components: unit-тест (wallet-history.tsx) | `artifacts/web/src/components/wallet-history.tsx` | o:artifacts/web/src/components/wallet-history.tsx | pending | agent |
| M-89 | O | web components: unit-тест (webgl-video-shader.tsx) | `artifacts/web/src/components/webgl-video-shader.tsx` | o:artifacts/web/src/components/webgl-video-shader.tsx | pending | agent |
