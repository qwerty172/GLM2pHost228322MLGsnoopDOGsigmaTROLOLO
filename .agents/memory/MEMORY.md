...
- [Agent telemetry channel](agent-telemetry.md) — agent errors flow to POST /api/agent-telemetry → agent_events table → dashboard card + server WARN logs; check there before asking user for logs.
